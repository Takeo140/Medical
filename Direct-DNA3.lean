...
inductive Transgene : Type
  | Ascl1 | Brn2  | Myt1l | NeuroD1  -- 神経分化リネージ因子群
  | Gata4 | Mef2c | Tbx5
...
/-- プロトコル1: 高効率BAM遺伝子カセットによる神経細胞のダイレクト創出 -/
def protocol_dna_to_neuron : DNAInductionProtocol :=
  { name          := "Direct_DNA_to_Neuron_BAM"
    blueprint     := { promoter_id := "Syn1", genes := [.Ascl1, .Brn2, .Myt1l] }
...
/-- プロトコル5: Runx2/Osterix 回路による造骨細胞へのゲノム誘導 -/
